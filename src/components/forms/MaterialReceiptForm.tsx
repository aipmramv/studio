...
import { CalendarIcon, PlusCircle, Save, Trash2, Loader2, Ban } from "lucide-react";
...
export function MaterialReceiptForm({ initialData, onSave, onCancel, isEditing }: MaterialReceiptFormProps) {
