            ...
            <div className="p-4 border rounded-md">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                <FormField control={form.control} name="assetNumber" render={({ field }) => (
                    <FormItem><FormLabel>Asset Number</FormLabel><FormControl><Input {...field} readOnly={!isEditing && !!initialData} /></FormControl><FormMessage /></FormItem>
                )}/>
                <FormField control={form.control} name="kmNumber" render={({ field }) => (
                    <FormItem><FormLabel>KM Number</FormLabel><FormControl><Input {...field} readOnly={!isEditing} /></FormControl><FormMessage /></FormItem>
                )}/>
                <FormField control={form.control} name="assetDescription" render={({ field }) => (
                    <FormItem className="md:col-span-2 lg:col-span-3"><FormLabel>Asset Description</FormLabel><FormControl><Textarea {...field} readOnly={!isEditing} /></FormControl><FormMessage /></FormItem>
                )}/>
              </div>
            </div>
            ...
            <div className="p-4 border rounded-md">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <FormField control={form.control} name="assetGrouping" render={({ field }) => (
                        <FormItem><FormLabel>Asset Grouping</FormLabel><FormControl><Input {...field} readOnly={!isEditing} /></FormControl><FormMessage /></FormItem>
                    )}/>
                </div>
            </div>
            ...
            <div className="p-4 border rounded-md">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                    <FormField control={form.control} name="capitalizationDate" render={({ field }) => (
                        ...
                        <Popover><PopoverTrigger asChild><FormControl><Button variant={"outline"} disabled={!isEditing} className={cn("pl-3 text-left font-normal", !field.value && "text-muted-foreground")}>{field.value ? format(new Date(field.value), "PPP") : <span>Pick a date</span>}<CalendarIcon className="w-4 h-4 ml-auto opacity-50" /></Button></FormControl></PopoverTrigger>
                     ...
                     <FormField control={form.control} name="lifecycleYears" render={({ field }) => (
                        <FormItem><FormLabel>Asset Life (Years)</FormLabel><FormControl><Input type="number" {...field} readOnly={!isEditing} onChange={e => field.onChange(parseInt(e.target.value, 10))}/></FormControl><FormMessage /></FormItem>
                    )}/>
                    <FormField control={form.control} name="purchaseValue" render={({ field }) => (
                        <FormItem><FormLabel>Purchase Value (INR)</FormLabel><FormControl><Input type="number" {...field} readOnly={!isEditing} onChange={e => field.onChange(parseFloat(e.target.value))}/></FormControl><FormMessage /></FormItem>
                    )}/>
                </div>
            </div>
            ...
            <div className="p-4 border rounded-md">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                    <FormField control={form.control} name="brandName" render={({ field }) => (
                        <FormItem><FormLabel>Brand Name</FormLabel><FormControl><Input {...field} readOnly={!isEditing} /></FormControl><FormMessage /></FormItem>
                    )}/>
                    <FormField control={form.control} name="modelNo" render={({ field }) => (
                        <FormItem><FormLabel>Model No.</FormLabel><FormControl><Input {...field} readOnly={!isEditing} /></FormControl><FormMessage /></FormItem>
                    )}/>
                    <FormField control={form.control} name="productSerialNo" render={({ field }) => (
                        <FormItem><FormLabel>Product Serial No.</FormLabel><FormControl><Input {...field} readOnly={!isEditing} /></FormControl><FormMessage /></FormItem>
                    )}/>
                    <FormField control={form.control} name="ledgerQty" render={({ field }) => (
                        <FormItem><FormLabel>Ledger Quantity</FormLabel><FormControl><Input type="number" {...field} readOnly={!isEditing} onChange={e => field.onChange(parseInt(e.target.value, 10))}/></FormControl><FormMessage /></FormItem>
                    )}/>
                </div>
            </div>
            ...
            <div className="p-4 border rounded-md">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                    <FormField control={form.control} name="personResponsible" render={({ field }) => (
                        <FormItem><FormLabel>Person Responsible (Custodian)</FormLabel><FormControl><Input {...field} readOnly={!isEditing} /></FormControl><FormMessage /></FormItem>
                    )}/>
                    <FormField control={form.control} name="currentUser" render={({ field }) => (
                        <FormItem><FormLabel>Current User</FormLabel><FormControl><Input {...field} readOnly={!isEditing} /></FormControl><FormMessage /></FormItem>
                    )}/>
                    ...
                    <FormField control={form.control} name="assetCoordinator" render={({ field }) => (
                        <FormItem><FormLabel>Asset Co-ordinator</FormLabel><FormControl><Input {...field} readOnly={!isEditing} /></FormControl><FormMessage /></FormItem>
                    )}/>
                    ...
                    <FormField control={form.control} name="onGoingProject" render={({ field }) => (
                        <FormItem><FormLabel>On-going Project</FormLabel><FormControl><Input {...field} readOnly={!isEditing} /></FormControl><FormMessage /></FormItem>
                    )}/>
                    <FormField control={form.control} name="weeklyUsageFrequency" render={({ field }) => (
                        <FormItem><FormLabel>Weekly Usage (Days)</FormLabel><FormControl><Input type="number" {...field} readOnly={!isEditing} onChange={e => field.onChange(parseInt(e.target.value, 10))}/></FormControl><FormMessage /></FormItem>
                    )}/>
                </div>
            </div>
            ...
            <div className="p-4 border rounded-md">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                    <FormField control={form.control} name="location" render={({ field }) => (
                        <FormItem><FormLabel>Location</FormLabel><FormControl><Input {...field} readOnly={!isEditing} /></FormControl><FormMessage /></FormItem>
                    )}/>
                    <FormField control={form.control} name="floor" render={({ field }) => (
                        <FormItem><FormLabel>Floor</FormLabel><FormControl><Input {...field} readOnly={!isEditing} /></FormControl><FormMessage /></FormItem>
                    )}/>
                    <FormField control={form.control} name="laboratory" render={({ field }) => (
                        <FormItem><FormLabel>Laboratory</FormLabel><FormControl><Input {...field} readOnly={!isEditing} /></FormControl><FormMessage /></FormItem>
                    )}/>
                </div>
            </div>
             ...
             <div className="p-4 border rounded-md">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <FormField control={form.control} name="comments" render={({ field }) => (
                        <FormItem className="md:col-span-2 lg:col-span-3"><FormLabel>Condition Comments</FormLabel><FormControl><Textarea {...field} readOnly={!isEditing} /></FormControl><FormMessage /></FormItem>
                    )}/>
                </div>
            </div>
                ...
                <h3 className="mb-4 text-lg font-medium">Attachments</h3>
                 <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <FormField control={form.control} name="attachments.invoice" render={({ field }) => (
                        <FormItem><FormLabel>Invoice</FormLabel><FileUpload onFileChange={field.onChange} disabled={!isEditing} /></FormItem>
                    )}/>
                     <FormField control={form.control} name="attachments.warranty" render={({ field }) => (
                        <FormItem><FormLabel>Warranty Certificate</FormLabel><FileUpload onFileChange={field.onChange} disabled={!isEditing} /></FormItem>
                    )}/>
                     <FormField control={form.control} name="attachments.calibration" render={({ field }) => (
                        <FormItem><FormLabel>Calibration Certificate</FormLabel><FileUpload onFileChange={field.onChange} disabled={!isEditing} /></FormItem>
                    )}/>
                     <FormField control={form.control} name="attachments.photo" render={({ field }) => (
                        <FormItem><FormLabel>Asset Photo</FormLabel><FileUpload onFileChange={field.onChange} accept="image/*" disabled={!isEditing} /></FormItem>
                    )}/>
                 </div>
            </div>
