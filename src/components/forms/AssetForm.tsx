...
import { DEPARTMENTS, TEAMS_AND_TRIBES, ASSET_CLASSIFICATIONS, ASSET_STATUSES, STORE_LOCATIONS, ASSET_GROUPINGS } from "@/lib/constants";
            ...
            <div className="p-4 border rounded-md">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                    <FormField control={form.control} name="capitalizationDate" render={({ field }) => (
                        ...
                        <Popover><PopoverTrigger asChild><FormControl><Button variant={"outline"} disabled={readOnly} className={cn("pl-3 text-left font-normal", !field.value && "text-muted-foreground")}>{field.value ? format(new Date(field.value), "PPP") : <span>Pick a date</span>}<CalendarIcon className="w-4 h-4 ml-auto opacity-50" /></Button></FormControl></PopoverTrigger>
            ...
            <div className="p-4 border rounded-md">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                    <FormField control={form.control} name="brandName" render={({ field }) => (
                        <FormItem><FormLabel>Brand Name</FormLabel><FormControl><Input {...field} readOnly={readOnly} /></FormControl><FormMessage /></FormItem>
                    )}/>
                    <FormField control={form.control} name="modelNo" render={({ field }) => (
                        <FormItem><FormLabel>Model No.</FormLabel><FormControl><Input {...field} readOnly={readOnly} /></FormControl><FormMessage /></FormItem>
                    )}/>
            ...
            <div className="p-4 border rounded-md">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <FormField control={form.control} name="floor" render={({ field }) => (
                        <FormItem><FormLabel>Floor</FormLabel><FormControl><Input {...field} readOnly={readOnly} /></FormControl><FormMessage /></FormItem>
                    )}/>
                    <FormField control={form.control} name="laboratory" render={({ field }) => (
                        <FormItem><FormLabel>Laboratory</FormLabel><FormControl><Input {...field} readOnly={readOnly} /></FormControl><FormMessage /></FormItem>
                    )}/>
                </div>
            </div>
             ...
             <div className="p-4 border rounded-md">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <FormField control={form.control} name="comments" render={({ field }) => (
                        <FormItem className="md:col-span-2 lg:col-span-3"><FormLabel>Condition Comments</FormLabel><FormControl><Textarea {...field} readOnly={readOnly} /></FormControl><FormMessage /></FormItem>
                    )}/>
                </div>
            </div>
                ...
                <h3 className="mb-4 text-lg font-medium">Attachments</h3>
                 <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <FormField control={form.control} name="attachments.invoice" render={({ field }) => (
                        <FormItem><FormLabel>Invoice</FormLabel><FileUpload onFileChange={field.onChange} disabled={readOnly} /></FormItem>
                    )}/>
                     <FormField control={form.control} name="attachments.warranty" render={({ field }) => (
                        <FormItem><FormLabel>Warranty Certificate</FormLabel><FileUpload onFileChange={field.onChange} disabled={readOnly} /></FormItem>
                    )}/>
                     <FormField control={form.control} name="attachments.calibration" render={({ field }) => (
                        <FormItem><FormLabel>Calibration Certificate</FormLabel><FileUpload onFileChange={field.onChange} disabled={readOnly} /></FormItem>
                    )}/>
                     <FormField control={form.control} name="attachments.photo" render={({ field }) => (
                        <FormItem><FormLabel>Asset Photo</FormLabel><FileUpload onFileChange={field.onChange} accept="image/*" disabled={readOnly} /></FormItem>
                    )}/>
                 </div>
            </div>
